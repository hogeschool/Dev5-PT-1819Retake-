    ...
    static void Main(string[] args)
    {
      ...
      var q1 =
        ...
        .Reduce(
          ...
          .Select(t => new { t.Departure, t.Destination });
      ...
      var q2 =
        ...
        .Join(
          TravelTable,
          (ct, t) => //TODO 4a: complete the implementation of query 2
          )
        .Map(t => /*TODO 4b: complete the implementation of query 2*/);

      /*
       * SELECT c.Departure, c.Destination
       * FROM Customer c INNER JOIN CustomerTravel ct
       * ON c.Id = ct.CustomerId INNER JOIN Travel t
       * ON t.Code = ct.TravelCode
      ...
      var q3 =
        ...
        .Join(
          //TODO 5a: complete the implementation of query3
          )
